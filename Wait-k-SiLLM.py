...
#         print('sample' + str(j))
#         j += 1
#         tmp_result = Waitk_policy(item_data["instruction"], item_data["input"], num_beams=1, waitk=waitk, max_new_tokens=52)
...
def main(
    ...
    output_translation_path: str = "",
    waitk: int = 1,
    csv_output_path: str = "output_log_k_equals_seven.csv",  # CSV file to store real-time updates
):
    base_model = base_model or os.environ.get("BASE_MODEL", "")
    assert (
        base_model
